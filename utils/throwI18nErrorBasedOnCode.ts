 ...
 * }
 */
export function throwI18nErrorBasedOnCode(event: H3Event<EventHandlerRequest>, code: string): never {
  const errorMessages: Record<string, { statusCode: number, message: string }> = {
    // General errors
